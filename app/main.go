...
//node's vars
var keyVals = make(map[string]string)      //map (dictionary) of string:string
...
var vClock = make(map[string]int)         //maps keys to logical clock values
var storedTimeStamp map[string]int //maps keys to latest timestamp
var hashRing []string              //sorted ring of hashes
var hashClusterMap = make(map[string]int)  //maps buckets to cluster indexes
var cDict = make(map[string]int)          //dictionary mapping node IPs to cluster indicies
